...
class lstm:
  ...
  def forwardprop(self, In):
    ...
    for i in range(self.CellSize):
      ...
      self.CellMem[i + 1, :] = self.CellMem[i, :] + self.CellMemGate[i, :]
  ...
  def backprop(self, OutError):
    ...
    for i in reversed(range(self.CellSize)):
      ...
      HidError = self.WeightsHidToOutputGate @ OutGateError + self.WeightsHidToCellMemGate @ CellMemGateError
      InError[i, :] = self.WeightsInToOutGate @ OutGateError + self.WeightsInToCellMemGate @ CellMemGateError
